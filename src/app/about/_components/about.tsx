...
export default function About() {
    return (
        <div className="max-w-3xl mx-auto p-6 space-y-6">
            <Card className="shadow-md transition duration-200 transform hover:scale-[1.03] hover:border-primary">
                <CardHeader>
                    <CardTitle>
                        About{" "}
            ...
            <Card className="shadow-sm border-dashed transition duration-200 transform hover:scale-[1.03] hover:border-primary">
                <CardHeader>
                ...
                <CardContent className="flex flex-col md:flex-row items-start md:items-center gap-4 text-muted-foreground md:align-middle">
                    <Avatar className="w-30 h-30">
                        <AvatarImage src="/runa.png" alt="Nadya" />
                        <AvatarFallback className="text-2xl">𖤐</AvatarFallback>
                    </Avatar>
